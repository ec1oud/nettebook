<?
	...
	if ($is_company)
	{
		$result = pg_Exec ($conn, "SELECT * FROM company WHERE entity_id=$other_id");
	...
	echo "<td align=right><a href = delete-conversation.php3?conversation_id=$conversation_id&entity_id=$other_id&is_company=$is_company>delete</a></td>\n";
	echo "</tr></table><hr>\n";
	echo $row[comment];
?>
