...
INCLUDEPATH += /usr/include/KF6/KIOCore ../deps/QJsonModel
!no_kio: INCLUDEPATH += /usr/include/KF6/KCoreAddons /usr/include/KF6/KIO
!no_kio: LIBS += -L/usr/lib/KF6 -lKF6KIOCore -lKF6CoreAddons
